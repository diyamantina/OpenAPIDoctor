...
| microsoft/kiota (.NET/multi) | ~1,544 | — | — | ~70 |
| apple/swift-openapi-generator | ~459 | — | ~35 | ~30 |
...
- **Paid GitHub Marketplace Action:** possible (verified-org only; GitHub takes 5%; $500/mo payout minimum) but **no credible solo-revenue examples** — weak, unproven channel.
