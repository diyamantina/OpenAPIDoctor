...
- [ ] `swiftformat . --config .swiftformat --lint` and `swiftlint lint --config .swiftlint.yml --strict` pass.
- [ ] `CHANGELOG.md` updated under `Unreleased` (or this change is docs/tests/config only).
- [ ] No tool attribution and no em dashes in commits, comments, or this description.
